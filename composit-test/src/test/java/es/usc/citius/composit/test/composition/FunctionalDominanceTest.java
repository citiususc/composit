...
public class FunctionalDominanceTest {
    ...
    public void test(WSCTest test, int expectedSize) throws Exception {
        ...
        assertTrue(Verifier.isExecutable(network1, dataset.getMatchGraph()));
        ...
        assertTrue(Verifier.isExecutable(network2, network1));
        assertTrue(Verifier.isExecutable(network3, network2));
    }
